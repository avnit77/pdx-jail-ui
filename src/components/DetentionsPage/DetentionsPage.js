          ...
          <div className="QueryControls">
            <label className="label" style={{ marginBottom: ".5rem" }}>
              ...
              >
                ...
                <option value="Multnomah County Sheriff Booking">
                  Multnomah County Sheriff Booking
                </option>
                <option value="Portland Police, Central Precinct">
                  Portland Police, Central Precinct
                </option>
                <option value="Portland Police, East Precinct">
                  Portland Police, East Precinct
                </option>
                <option value="Portland Police, North Precinct">
                  Portland Police, North Precinct
                </option>
                <option value="Portland Police, Other">
                  Portland Police, Other
                </option>
                <option value="Portland Sheriff">Portland Sheriff</option>
                <option value="Portland FBI">Portland FBI</option>
                <option value="Portland State Police">
                  Portland State Police
                </option>
                <option value="Troutdale Police">Troutdale Police</option>
                <option value="PSU">PSU</option>
                <option value="OHSU University Police">
                  OHSU University Police
                </option>
                <option value="Port of Portland">Port of Portland</option>
                <option value="Portland Criminal Court">
                  Portland Criminal Court
                </option>
                ...
                <option value="Community Corrections">
                  Community Corrections
                </option>
                <option value="Tri-Met Police">Tri-Met Police</option>
                <option value="Drug Enforcement Administration">
                  Drug Enforcement Administration
                </option>
                <option value="Gresham Police Department">
